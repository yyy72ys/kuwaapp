...
export const Dashboard: React.FC<DashboardProps> = ({ individuals, onSelectIndividual, userPlan, onUpgradeClick, onAddIndividualClick }) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
            <button 
                ...
                disabled={atLimit}
                onClick={() => atLimit ? onUpgradeClick() : onAddIndividualClick()}
