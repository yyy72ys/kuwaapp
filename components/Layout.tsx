...
import { BeetleIcon, UploadIcon, ShieldCheckIcon, ArrowLeftOnRectangleIcon } from './icons';
...
export const Layout: React.FC<LayoutProps> = ({ children, onImportClick, onNavigate, currentView }) => {
  return (
