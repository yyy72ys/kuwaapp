...
import { ArrowLeftIcon, BeetleIcon, SparklesIcon, DocumentTextIcon } from './icons';
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        ...
                        <div className="w-full">
                           ...
                           <div className="mt-6 border-t border-slate-200 pt-6">
                                <h3 className="font-semibold mb-2 text-slate-800">血統証明書</h3>
                                <a 
                                    href="#simulated-public-pedigree-download" 
                                    download={`pedigree-${individual.individualCode}.pdf`}
                                    className="inline-flex items-center gap-2 rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white bg-emerald-600 text-white hover:bg-emerald-700 h-10 px-4 py-2"
                                >
